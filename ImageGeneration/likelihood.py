...
# pylint: skip-file
# pytype: skip-file
"""Log-likelihood computation in bits per dimension."""
...
def get_likelihood_fn_rf(sde, inverse_scaler, hutchinson_type='Rademacher',
  ...
  def drift_fn(model, x, t):
    """The drift function of the rectified flow ODE."""
  ...
  def likelihood_fn(model, data):
    ...
    with torch.no_grad():
      ...
      def ode_func(t, x):
        ...
        drift = mutils.to_flattened_numpy(drift_fn(model, sample, vec_t*999))
